...
export VIO_WAYPOINTS=campus_vio/campus_stress_waypoints.csv
...
#
# Rendering: with VIO_WAYPOINTS set (above), the render follows this
# waypoint circuit; see campus_baseline_env.sh.
