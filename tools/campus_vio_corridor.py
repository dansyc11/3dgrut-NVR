...
def cmd_build(args):
    ...
    for kind, h_real, stress, fps, name in (
        ...
        prof = {"kind": kind, "v_peak": 4.0, "v_stop": 0.22}
...
def main():
    ...
    for name in ("build", "check"):
        ...
        s.add_argument("--images-bin",
                       default="/home/vilota/datasets/main_campus/colmap/"
                               "model/images.bin")
        s.add_argument("--alignment",
                       default="/home/vilota/datasets/main_campus/"
                               "lidar_alignment.json")
        if name == "build":
