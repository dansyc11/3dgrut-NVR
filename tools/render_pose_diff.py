...
Run (GPU, ~1 min):
  /home/vilota/niel_gs/3dgrut/.venv/bin/python tools/render_pose_diff.py
Optional: --run_dir <run> --dataset <path> --frame <val idx> --prune_smax 5.0
...
def main():
    ...
    ap.add_argument("--run_dir", default=str(REPO / "runs/meetingroom_fiord_masked/meetingroom-1409_140247"))
    ap.add_argument("--dataset", default=os.path.expanduser("~/datasets/meetingroom"))
